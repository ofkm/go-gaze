...
//
// A Config is a plain value and may be reused: its constructor methods
// ([Config.NewWatcher], [Config.WatchDirectory], [Config.WatchFile]) copy the
// receiver, so one Config can create any number of independent watchers.
type Config struct {
